...
function exportToCSV() {
  ...
  $sql = "SELECT * FROM files WHERE file_directory IN ('College of Medicine', 'General') AND CURDATE() <= valid_until";
...
if (isset($_GET['export'])) {
  ...
  if ($sortOption === 'upload_date') {
      ...
      $sql = "SELECT * FROM files WHERE (file_directory = 'College of Medicine' || file_directory = 'General') && CURDATE() <= valid_until AND file_course = '$selectedCourse' ORDER BY STR_TO_DATE(upload_date, '%Y-%m-%d') $dateOrder LIMIT $limit OFFSET $offset";
  } else {
      // For other columns
      $sql = "SELECT * FROM files WHERE (file_directory = 'College of Medicine' || file_directory = 'General') && CURDATE() <= valid_until AND file_course = '$selectedCourse' ORDER BY $sortOption $order LIMIT $limit OFFSET $offset";
  }
