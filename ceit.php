...
function exportToCSV() {
  ...
  $sql = "SELECT * FROM files WHERE file_directory IN ('CEIT', 'General') AND CURDATE() <= valid_until";
...
if (isset($_GET['export'])) {
  ...
  $totalRecords = $mysqli->query("SELECT COUNT(*) as total FROM files WHERE file_directory = 'CEIT' && CURDATE() <= valid_until || file_directory = 'General' && CURDATE() <= valid_until ")->fetch_assoc()['total'];
  ...
  if ($sortOption === 'upload_date') {
      ...
      $sql = "SELECT * FROM files WHERE (file_directory = 'CEIT' || file_directory = 'General') && CURDATE() <= valid_until AND file_course = '$selectedCourse' ORDER BY STR_TO_DATE(upload_date, '%Y-%m-%d') $dateOrder LIMIT $limit OFFSET $offset";
  } else {
      // For other columns
      $sql = "SELECT * FROM files WHERE (file_directory = 'CEIT' || file_directory = 'General') && CURDATE() <= valid_until AND file_course = '$selectedCourse' ORDER BY $sortOption $order LIMIT $limit OFFSET $offset";
  }
            ...
            <div id="sidenav" style="<?php echo (getUserLevel() == 2) ? 'display:none;' : ''; echo (getUserLevel() == 3) ? 'display:none;' : '';?>">
                ...
                <div class="col-md-8">
                    <div class="alert alert-info" style="margin-top: 10px; width: 500px; display: flex; align-items: center;">
                        <span style="margin-right: 10px;">CEIT  </span>
                        <form method="GET">
                            <select class="form-select" id="fileDirectoryDropdown" name="course" style="width: 430px; padding: 5px; border-radius: 5px;" onchange="this.form.submit()">
                                ...
                                <option value="Bachelor of Science in Agricultural and Biosystems Engineering" <?php echo $selectedCourse === 'Bachelor of Science in Agricultural and Biosystems Engineering' ? 'selected' : ''; ?>>Bachelor of Science in Agricultural and Biosystems Engineering</option>
                                <option value="Bachelor of Science in Architecture" <?php echo $selectedCourse === 'Bachelor of Science in Architecture' ? 'selected' : ''; ?>>Bachelor of Science in Architecture</option>
                                <option value="Bachelor of Science in Civil Engineering" <?php echo $selectedCourse === 'Bachelor of Science in Civil Engineering' ? 'selected' : ''; ?>>Bachelor of Science in Civil Engineering</option>
                                <option value="Bachelor of Science in Computer Engineering" <?php echo $selectedCourse === 'Bachelor of Science in Computer Engineering' ? 'selected' : ''; ?>>Bachelor of Science in Computer Engineering</option>
                                <option value="Bachelor of Science in Computer Science" <?php echo $selectedCourse === 'Bachelor of Science in Computer Science' ? 'selected' : ''; ?>>Bachelor of Science in Computer Science</option>
                                <option value="Bachelor of Science in Electrical Engineering" <?php echo $selectedCourse === 'Bachelor of Science in Electrical Engineering' ? 'selected' : ''; ?>>Bachelor of Science in Electrical Engineering</option>
                                <option value="Bachelor of Science in Electronics Engineering" <?php echo $selectedCourse === 'Bachelor of Science in Electronics Engineering' ? 'selected' : ''; ?>>Bachelor of Science in Electronics Engineering</option>
                                <option value="Bachelor of Science in Industrial Engineering" <?php echo $selectedCourse === 'Bachelor of Science in Industrial Engineering' ? 'selected' : ''; ?>>Bachelor of Science in Industrial Engineering</option>
                                <option value="Bachelor of Science in Industrial Technology" <?php echo $selectedCourse === 'Bachelor of Science in Industrial Technology' ? 'selected' : ''; ?>>Bachelor of Science in Industrial Technology</option>
                                <option value="Bachelor of Science in Information Technology" <?php echo $selectedCourse === 'Bachelor of Science in Information Technology' ? 'selected' : ''; ?>>Bachelor of Science in Information Technology</option>
                                <option value="Bachelor of Science in Office Administration" <?php echo $selectedCourse === 'Bachelor of Science in Office Administration' ? 'selected' : ''; ?>>Bachelor of Science in Office Administration</option>
