...
$totalRecords = $mysqli->query("SELECT COUNT(*) as total FROM files WHERE file_directory = 'CCJ' || file_directory = 'General'")->fetch_assoc()['total'];
...
if ($sortOption === 'upload_date') {
    ...
    $sql = "SELECT * FROM files WHERE file_directory = 'CCJ' || file_directory = 'General' ORDER BY STR_TO_DATE(upload_date, '%Y-%m-%d') $dateOrder LIMIT $limit OFFSET $offset";
} else {
    // For other columns
    $sql = "SELECT * FROM files WHERE file_directory = 'CCJ' || file_directory = 'General' ORDER BY $sortOption $order LIMIT $limit OFFSET $offset";
}
        ...
        <div class="box">
            ...
            <div id="sidenav" style="<?php echo (getUserLevel() == 2) ? 'display:none;' : ''; echo (getUserLevel() == 3) ? 'display:none;' : '';?>">
                ...
                <div class="profile-boxx">
                    <div class="col-md-8">
		            <div class="alert alert-info" style="margin-top:10px;width:450px"> CCJ</div>
